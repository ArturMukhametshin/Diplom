...
## Структура проекта.
Рисунок 1. Главная страница. На главной странице расположено основное меню, наследуемое на все остальные страницы. Ссылки портфолио, услуги, контакты и регистрация переводят на соответствующие страницы. Логотип "Капкейк" - это ссылка на главную страницу.
